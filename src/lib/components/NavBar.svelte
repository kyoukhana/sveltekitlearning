...
<header class="absolute h-screen w-full bg-daisyBush text-center md:relative -translate-x-full md:translate-x-0 md:col-span-3" class:translate-x-0={isNavShowing}>
